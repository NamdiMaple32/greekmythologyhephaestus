...
function didCollideWithObject() {
    ...
    if (this.name === 'marriage') {
        ...
        if (this.name === 'marriage') {
            hephaestus.quests.marriage = true;
            aphrodite.dialogue ="Hephaestus! Just the handsome devil I wanted to see! I heard you were appointed blacksmith of the Gods! And you want to be married. Normally I'd puke my guts out at the idea of touching you, but this newfound position of power you've gained is insanely attractive to say the least. Your bushy eyebrows don't remind me of disease riddled sewer rats as much as they used to...And your shiny bald head is like a spherical mirror in which I can observe my beauty at any time...The unidentifiable stains on your shirt bring out the color of you puffy eyes...and your liver spotted hands are begging to hold me...Hephaestus my love.....as long as I can manipulate your existence to benefit my own...I will cherish you."}

        if (this.name === 'marriage') {
            hephaestus.quests.marriage = true;
            zeus.dialogue = "Yo Hephaestus! I heard about how you manipulated your mother in order to achieve you selfish, hate-filled desires! That's dope! I always hated that woman. She's such a nag! So I sleep with other women every other night! What's the big dealio huh!? She acts like these dumb wedding rings are like a symbol of our love and loyalty to one another or something ridiculous like that...I wish I was smart and talented enough to have come up with a revenge scheme like that. To be honest, I'm insecure about my intelligence. Actually, I'm insecure about every aspect of myself. I mask my anxieties with hyper masculinity because I think that if I act big no one will see through me. The truth is, I find absolutley no pleasure in the stimulants in which I sometimes so madly indulge. It has not been in the pursuit of pleasure that I have periled life and reputation and reason. It has been in the desperate attempt to escape from torturing memories, an sense of insupportanble loneliness, and dread of some strange impending doom. Uh.. I mean...FOOTBALL. "
        }
